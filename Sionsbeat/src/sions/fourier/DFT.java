...
public class DFT extends FourierTransform
{
	 ...
	 * @param sampleRate
	 *                the sample rate of the audio samples you plan to
	 *                analyze
	 */
	...
	{
		if ( samples.length != timeSize ) { throw new IllegalArgumentException( "DFT.forward: The length of the passed sample buffer must be equal to DFT.timeSize()." ); }
		doWindow( samples );
